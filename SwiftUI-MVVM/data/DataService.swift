...
struct DataService {
    ...
    static var places: [Place] {
        ...
        [Place(id: 1, name: "Ohrid lake", image: "ohrid_lake", category: .lake, country: "Macedonia"),
         ...
         Place(id: 8, name: "Nile", image: "nile_river", category: .river, country: "Egypt"),
         Place(id: 9, name: "Cano Cristales", image: "cano_cristales", category: .river, country: "Colombia"),
         
         // mountains
         Place(id: 10, name: "Mount Fuji", image: "mount-fuji", category: .mountain, country: "Japan"),
         Place(id: 11, name: "Huayna Picchu", image: "hauyna-picchu", category: .mountain, country: "Peru"),
         Place(id: 12, name: "Kirkjufell", image: "Kirkjufell", category: .mountain, country: "Iceland"),
        ]
    }
